    ...
    return (<div className="employeeForm">
        ...
        >
            <div className="employeeFormContainer">
                <p>Name</p>
                <input className="employeeInput" placeholder="Enter product name" type="name" onChange={handleChange} value={getValue("name")}/>
                <p>Cost</p>
                <input className="employeeInput" placeholder="Enter product cost" type="cost" onChange={handleChange} value={getValue("cost")}/>
